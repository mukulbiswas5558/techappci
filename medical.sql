...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2022 at 03:36 PM
...
(3, 'mukulbiswas5558@gmail.com', 'password', 'mukul', 'Dr.', 'admin', 'wb', '4323432423', 1, '2022-11-27', 'kolkata', 'hi', 'jszxx', 'zx', 'india', '657', 'SOVAPUR'),
(4, 'sumit@gmail.com', 'password', 'sumit5', 'Dr.', 'doctor', 'wb', '89222000', 1, '2022-11-25', 'dd', 'hi sumit', '', '', '', '', ''),
(5, 'simanto@gmail.com', 'password', 'simanto', 'Mr.', 'patient', 'wb', '012331', 1, '2022-11-24', 'szs', '', '', '', '', '', ''),
...
--
ALTER TABLE `booking`
  MODIFY `bookingId` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
